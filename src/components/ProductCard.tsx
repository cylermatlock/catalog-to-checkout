  ...
  return (
    <div className="bg-card rounded-lg overflow-hidden hover:shadow-lg transition-shadow group border-4 border-solid border-primary">
      <div className="aspect-[4/3] bg-secondary flex items-center justify-center overflow-hidden relative">
        ...
        {product.exclusiveDealer && (
          <span
            className="absolute bottom-2 left-2 right-2 bg-primary/95 text-primary-foreground text-[9px] font-bold uppercase tracking-wider px-2 py-1 rounded shadow-md text-center"
            title="GM Therapy is the exclusive dealer in Texas, Oklahoma, and New Mexico"
          >
            ★ Exclusive Dealer · TX/OK/NM
          </span>

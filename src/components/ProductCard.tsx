...
const ProductCard = ({ product, featured = false }: ProductCardProps) => {
  ...
  if (featured) {
    return (
      <div className="group bg-card rounded-lg overflow-hidden border-4 border-foreground shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col">

...
export const productDetails: Record<string, ProductDetail> = {
  ...
  "626": {
    ...
    gallery: [
      { src: "/assets/products/matrix/tbc/main.png", alt: "Matrix Total Body Cycle — main product view" },
  ...
  // LumaNova LumaPod Pro — product id "638"
  "638": {
    productId: "638",
    slug: "lumanova-lumapod-pro",
    tagline: "Clinical-grade full-body red light therapy bed with 45,000 medical-grade LEDs and 5 therapeutic wavelengths.",
    overview: [
      "The LumaPod Pro® is the flagship full-body red-light therapy bed from LumaNova — engineered and patented for clinics, gyms, and high-performance individuals who demand the most advanced red-light therapy on the market. With 45,000 German-made LEDs delivering five clinically researched wavelengths in equal proportions, it accelerates recovery, enhances cellular wellness, and drives measurable practice ROI.",
      "Developed by world-renowned wellness expert Dr. Paul Barattiero, the LumaPod Pro® combines a patented internal geometry that maximizes light reflection and absorption with digital power controllers 3.5× larger than competitors — delivering a lab-verified irradiance up to 52.7 mW/cm² for shorter, more effective sessions. A 12-fan cooling system (3 for the user, 9 for the bed) keeps everything comfortable during high-volume continuous use.",
      "A user-friendly touchscreen ships with 63 expert-built preset protocols covering pain relief, recovery, skin health, and longevity, with full custom-protocol creation and Bluetooth™ audio. The spacious 84\" × 36\" treatment area accommodates users up to 7'3\" and 650 lb, while the low-to-the-ground build keeps entry and exit easy for everyone.",
    ],
    highlights: [
      "45,000 high-quality German LEDs with 100,000-hour lifespan",
      "5 clinical wavelengths: 633, 660, 810, 850, 940 nm in equal proportions",
      "Lab-verified true irradiance up to 52.7 mW/cm² (Light Lab International)",
      "Patented design maximizes reflection, refraction & light absorption",
      "63 preset Dr.-developed protocols + custom programs via touchscreen",
      "Bluetooth™ audio for music & media during sessions",
      "12-fan advanced cooling system for continual high-volume use",
      "Spacious 84\" × 36\" treatment area, accommodates users up to 7'3\" / 650 lb",
      "5-year warranty with lifetime LED guarantee",
      "CE, RoHS, and FDA certified",
      "Standard white-glove delivery included",
    ],
    gallery: [
      { src: "/assets/products/lumanova/lumapod-pro/hero.png", alt: "LumaNova LumaPod Pro red light therapy bed — hero front view" },
      { src: "/assets/products/lumanova/lumapod-pro/lifestyle.jpg", alt: "LumaNova LumaPod Pro interior glowing with red and near-infrared light" },
      { src: "/assets/products/lumanova/lumapod-pro/view-1.jpg", alt: "LumaPod Pro with Dr. Kaylee — clinical setting" },
      { src: "/assets/products/lumanova/lumapod-pro/view-2.jpg", alt: "LumaPod Pro alternate view in treatment room" },
      { src: "/assets/products/lumanova/lumapod-pro/view-3.jpg", alt: "LumaPod Pro with assistant model demonstrating bed access" },
    ],
    specGroups: [
      {
        title: "Light Performance",
        rows: [
          { label: "Wavelengths", value: "633 nm, 660 nm, 810 nm, 850 nm, 940 nm (equal proportions)" },
          { label: "True Irradiance", value: "Up to 52.7 mW/cm² (3rd-party lab verified)" },
          { label: "LED Count", value: "45,000 high-quality German LEDs" },
      ...
      },
      {
        ...
        rows: [
          { label: "Touchscreen", value: "Proprietary touchscreen control system" },
          { label: "Preset Protocols", value: "63 Dr.-developed presets" },
          { label: "Custom Protocols", value: "Yes — fully customizable wavelengths, timing, pulse frequency" },
          { label: "Audio", value: "Bluetooth™ enabled" },
          { label: "Cooling System", value: "12 fans (3 user / 9 bed)" },
        ],
      },
      {
        title: "Dimensions & Capacity",
        rows: [
          { label: "Treatment Area", value: "84\" × 36\" (213.3 × 91.4 cm)" },
          { label: "Overall Length", value: "89.8\" (228.1 cm)" },
          { label: "Overall Width", value: "47.4\" (120.4 cm)" },
          { label: "Overall Height", value: "54.7\" (139.0 cm)" },
          { label: "Tunnel Height", value: "2 ft (61 cm)" },
          { label: "User Weight Capacity", value: "650 lb (200 kg)" },
          { label: "Max User Height", value: "7'3\"" },
          { label: "Bed Weight", value: "660 lb (300 kg)" },
        ],
      },
      {
        title: "Power & Certifications",
        rows: [
          { label: "Power Requirement", value: "220V / 50 Amps" },
          { label: "Plug", value: "NEMA L6-30" },
          { label: "Certifications", value: "CE, RoHS, FDA" },
          { label: "Exterior Finish", value: "Piano Black" },
        ],
      },
      {
        title: "Delivery & Warranty",
        rows: [
          { label: "Delivery", value: "Standard white-glove delivery included (room-of-choice optional)" },
          { label: "Warranty", value: "5-Year warranty on all components" },
          { label: "LED Guarantee", value: "Limited Lifetime LED Guarantee" },
          { label: "Included Support", value: "$5,000+ in staff training, marketing materials, patient resources & expert consultation" },
        ],
      },
    ],
    sourceUrl: "https://lumanova.com/products/lumapod-pro",
    seo: {
      title: "LumaNova LumaPod Pro Red Light Therapy Bed | GM Therapy",
      description: "LumaNova LumaPod Pro: clinical-grade full-body red light therapy bed with 45,000 LEDs, 5 wavelengths, 52.7 mW/cm² irradiance, 650 lb capacity. Texas dealer.",
    },
  },

  // LumaNova LumaPod — product id "639"
  "639": {
    productId: "639",
    slug: "lumanova-lumapod",
    tagline: "Powerful full-body red light therapy bed with 26,800 medical-grade LEDs and 5 therapeutic wavelengths.",
    overview: [
      "The LumaPod® is LumaNova's flagship full-body red-light therapy bed — engineered for medical practices, elite facilities, and private wellness spaces that demand uncompromising performance, reliability, and results. With 26,800 high-quality German LEDs delivering five clinically researched wavelengths in equal proportions, it accelerates recovery, reduces inflammation, and drives measurable client and practice outcomes.",
      "Developed by world-renowned wellness expert Dr. Paul Barattiero, the LumaPod® combines a patented design that maximizes light reflection and refraction with a lab-verified true irradiance up to 73.9 mW/cm² — meaning shorter sessions deliver the same effect as competitors' lower-irradiance products. A 9-fan cooling system keeps both bed and user comfortable during high-volume continuous use.",
      "A user-friendly touchscreen ships with 63 expert-built preset protocols covering pain relief, recovery, skin health, and longevity, with full custom-protocol creation and Bluetooth™ audio. The spacious 77\" × 34\" treatment area accommodates users up to 450 lb, while the low-profile design ensures easy entry and exit.",
    ],
    highlights: [
      "26,800 high-quality German LEDs with 100,000-hour lifespan",
      "5 clinical wavelengths: 633, 660, 810, 850, 940 nm in equal proportions",
      "Lab-verified true irradiance up to 73.9 mW/cm² (Light Lab International)",
      "Patented design maximizes reflection, refraction & light absorption",
      "63 preset Dr.-developed protocols + custom programs via touchscreen",
      "Bluetooth™ audio for music & media during sessions",
      "9-fan advanced cooling system for continual high-volume use",
      "Spacious 77\" × 34\" laying area, supports users up to 450 lb",
      "3-year warranty with limited lifetime LED guarantee",
      "CE, RoHS, and FDA certified",
      "Standard white-glove delivery included",
    ],
    gallery: [
      { src: "/assets/products/lumanova/lumapod/hero.png", alt: "LumaNova LumaPod red light therapy bed — hero front view" },
      { src: "/assets/products/lumanova/lumapod/lifestyle.png", alt: "LumaNova LumaPod interior glowing with red and near-infrared light" },
      { src: "/assets/products/lumanova/lumapod/view-1.jpg", alt: "LumaPod in gym setting" },
      { src: "/assets/products/lumanova/lumapod/view-2.jpg", alt: "LumaPod with model demonstrating bed access" },
      { src: "/assets/products/lumanova/lumapod/view-3.jpg", alt: "LumaPod installed in wellness facility" },
    ],
    specGroups: [
      {
        title: "Light Performance",
        rows: [
          { label: "Wavelengths", value: "633 nm, 660 nm, 810 nm, 850 nm, 940 nm (equal proportions)" },
          { label: "True Irradiance", value: "Up to 73.9 mW/cm² (3rd-party lab verified)" },
          { label: "LED Count", value: "26,800 high-quality German LEDs" },
          { label: "LED Lifespan", value: "100,000 hours" },
        ],
      },
      {
        ...
        rows: [
          ...
          { label: "Custom Protocols", value: "Yes — fully customizable wavelengths, timing, pulse frequency" },
          { label: "Audio", value: "Bluetooth™ enabled" },
          { label: "Cooling System", value: "9 fans" },
        ],
      },
      {
        title: "Dimensions & Capacity",
        rows: [
          { label: "Laying Area", value: "77\" × 34\" (195.6 × 86.4 cm)" },
          { label: "Overall Length", value: "84.5\" / 7.04 ft (214.6 cm)" },
          { label: "Overall Width", value: "42\" (106.6 cm)" },
          { label: "Overall Height", value: "34\" (86.4 cm)" },
          { label: "Tunnel Height", value: "1.24 ft (37.8 cm)" },
          { label: "User Weight Capacity", value: "450 lb (250 kg)" },
          { label: "Bed Weight", value: "440 lb (200 kg)" },
        ],
      },
      {
        title: "Power & Certifications",
        rows: [
          { label: "Power Requirement", value: "220V / 30 Amps" },
          { label: "Plug", value: "NEMA L6-30" },
          { label: "Certifications", value: "CE, RoHS, FDA" },
          { label: "Exterior Finish", value: "Piano Black" },
        ],
      },
      {
        ...
        rows: [
          { label: "Delivery", value: "Standard white-glove delivery included (room-of-choice optional)" },
          { label: "Warranty", value: "3-Year warranty on all components" },
          { label: "LED Guarantee", value: "Limited Lifetime LED Guarantee" },
          { label: "Included Support", value: "$5,000+ in staff training, marketing materials, patient resources & expert consultation; FREE Echo Clean™" },
        ],
      },
    ],
    sourceUrl: "https://lumanova.com/products/lumapod",
    seo: {
      title: "LumaNova LumaPod Red Light Therapy Bed | GM Therapy",
      description: "LumaNova LumaPod: full-body red light therapy bed with 26,800 LEDs, 5 wavelengths, up to 73.9 mW/cm² irradiance, 450 lb capacity. Texas dealer.",
    },
  },
  ...
  "640": {
    ...
    overview: [
      "The LumaMobile® is a professional-grade mobile red-light therapy half-bed designed for practitioners and individuals who need clinical-level treatments without dedicating a full room to a bed. It positions easily over a massage table or bed, delivering powerful five-wavelength light therapy in any treatment space.",
      "Developed by world-renowned wellness expert Dr. Paul Barattiero, the LumaMobile® emits 633, 660, 810, 850, and 940 nm — individually controllable in constant or pulsed mode — at a clinical-grade ~60 mW/cm² irradiance. A 7\" color touchscreen controls every aspect of treatment, including time, panel height, wavelength selection, and pulse frequency.",
      "Designed for flexibility: a 360° rotating arm, adjustable height, and a sturdy rolling frame with two locking wheels make it easy to move between rooms and clients. A built-in TENS unit (just connect the pads) and Bluetooth speakers for music round out a complete professional experience — all backed by a 2-year warranty.",
    ],
    highlights: [
      "Mobile half-bed design fits over any massage table or bed",
      "5 clinical wavelengths: 633, 660, 810, 850, 940 nm",
      "Individually controllable wavelengths — constant or pulsed",
      "~60 mW/cm² clinical-grade irradiance",
      "360° rotating arm with adjustable height",
      "7\" color touchscreen control system",
      "Built-in TENS unit — connect pads and treat",
      "Bluetooth™ audio with built-in speakers",
      "5-fan cooling system for continuous use",
      "Sturdy rolling frame with two locking wheels",
      "2-year warranty on all components",
    ],
    gallery: [
      { src: "/assets/products/lumanova/lumamobile/hero.jpg", alt: "LumaNova LumaMobile mobile red light therapy half-bed — hero view" },
      { src: "/assets/products/lumanova/lumamobile/view-1.jpg", alt: "LumaNova LumaMobile positioned over treatment table" },
    ],
    specGroups: [
      {
        title: "Light Performance",
        rows: [
          { label: "Wavelengths", value: "633 nm, 660 nm, 810 nm, 850 nm, 940 nm" },
          { label: "Wavelength Control", value: "Each wavelength individually controllable" },
          { label: "Mode", value: "Constant or pulsed light" },
          { label: "Irradiance", value: "~60 mW/cm²" },
        ],
      },
      {
        title: "Controls & Experience",
        rows: [
          { label: "Touchscreen", value: "7\" color touchscreen" },
          { label: "TENS Unit", value: "Built-in — connect pads and treat" },
          { label: "Audio", value: "Bluetooth™ with built-in speakers" },
          { label: "Cooling System", value: "5 fans" },
        ],
      },
      {
        title: "Mobility & Build",
        rows: [
          { label: "Form Factor", value: "Mobile half-bed (fits over massage table or bed)" },
          { label: "Arm Movement", value: "360° rotating arm" },
          { label: "Height Adjustment", value: "Yes — fully adjustable" },
          { label: "Wheels", value: "Rolling frame with two locking wheels" },
        ],
      },
      {
        title: "Warranty",
        rows: [
          { label: "Warranty", value: "2-year warranty on all components" },
        ],
      },
    ],
    sourceUrl: "https://lumanova.com/products/lumamobile",
    seo: {
  ...
  "643": {
    ...
    gallery: [
      { src: "/assets/products/lumanova/lumabag/max-main.png", alt: "LumaNova LumaBag Max red light therapy bag — hero view" },
  ...
  "700": {
    ...
    highlights: [
      ...
      "325+ pre-programmed workouts",
      "Fits users from 4'6\" to 7' tall",
      "Trusted by NFL, MLB, and D1 collegiate programs",
    ],
    gallery: [
      { src: "/assets/products/boost/boost2.jpg", alt: "BOOST 2 Core microgravity anti-gravity treadmill — hero view" },
      { src: "/assets/products/boost/b2_18.webp", alt: "BOOST 2 Core treadmill — alternate angle" },
      { src: "/assets/products/boost/b2_20230617-722A1833_1.jpg", alt: "Athlete training inside the BOOST 2 air-pressure chamber" },
    ...
    specGroups: [
      {
        ...
        rows: [
          ...
          { label: "Running surface", value: "Patented Woodway 4Front slat belt" },
        ],
      },
      {
        title: "User & Programs",
        rows: [
          { label: "User height", value: "4'6\" – 7'0\"" },
          { label: "Tracked metrics", value: "Calories, heart rate, relative weight impact, distance, pace" },
          { label: "Programs", value: "325+ pre-programmed workouts" },
        ],
      },
    ],
    sourceUrl: "https://boosttreadmills.com/pages/boost-2",
    seo: {
  ...
  // BOOST 2 Elite — product id "701"
  "701": {
    productId: "701",
    slug: "boost-2-elite",
    tagline:
      "Elite-sprint configuration of the BOOST 2 microgravity treadmill — top speed 18 mph.",
    overview: [
      "The BOOST 2 Elite is the high-speed configuration of the BOOST 2 microgravity treadmill. Mechanically identical to the BOOST 2 Core, the Elite is purpose-built for elite-sprint training with a top speed of 18 mph — the fastest in the microgravity category.",
      "Combine 80% bodyweight reduction with sub-maximal sprint mechanics to keep elite athletes training at full speed while protecting joints and tissue. Trusted by NFL, MLB, and D1 collegiate programs nationwide.",
    ],
    highlights: [
      "Top speed up to 18 mph — built for elite sprint training",
      "Reduce bodyweight up to 80% (20–100% in 1% increments)",
      "Incline 0–15% in 0.5% increments",
      "Patented Woodway 4Front slat-belt running surface",
      "Tracks calories, heart rate, relative weight impact, distance & pace",
    ...
    gallery: [
      { src: "/assets/products/boost/boost2.jpg", alt: "BOOST 2 Elite microgravity anti-gravity treadmill — hero view" },
    ...
    specGroups: [
      {
        title: "Performance",
        rows: [
          { label: "Top speed", value: "18 mph (elite sprint)" },
          { label: "Speed increments", value: "0.1 mph" },
          { label: "Incline", value: "0–15% in 0.5% increments" },
          { label: "Bodyweight reduction", value: "Up to 80% (20–100% in 1% increments)" },
          { label: "Running surface", value: "Patented Woodway 4Front slat belt" },
    ...
    sourceUrl: "https://boosttreadmills.com/pages/boost-2",
    seo: {
      title: "BOOST 2 Elite Microgravity Treadmill — 18 mph | GM Therapy Solutions",
      description:
        "BOOST 2 Elite anti-gravity treadmill: 18 mph top speed for elite sprint training, 80% bodyweight reduction, Woodway slat-belt surface. TX/OK/NM dealer.",
    },
  },

  // BOOST 3 — product id "702"
  "702": {
    productId: "702",
    slug: "boost-3",
    tagline:
      "Next-generation microgravity treadmill — refined chamber, updated controls, built for clinic and home.",
    overview: [
      "The BOOST 3 is the next generation of the BOOST microgravity platform. It pairs a refined air-pressure chamber and updated control interface with the same differential air-pressure unweighing technology trusted by elite professional and collegiate programs.",
      "Engineered for clinical rehab, return-to-sport, and at-home performance training, the BOOST 3 makes high-intensity training and post-injury rehabilitation accessible to a broader range of athletes and patients.",
    ],
    highlights: [
    ...
    gallery: [
      { src: "/assets/products/boost/boost3.jpg", alt: "BOOST 3 microgravity treadmill — hero view" },
      { src: "/assets/products/boost/b3_10.webp", alt: "BOOST 3 treadmill — alternate angle" },
      { src: "/assets/products/boost/b3_20230618-722A1873.jpg", alt: "Athlete training inside a BOOST 3 microgravity treadmill" },
      { src: "/assets/products/boost/b3_Z8A_2172-webres.jpg", alt: "BOOST 3 in a clinical performance setting" },
    ...
    sourceUrl: "https://boosttreadmills.com/pages/boost-3",
    seo: {
      title: "BOOST 3 Microgravity Treadmill | GM Therapy Solutions",
      description:
        "BOOST 3 next-generation anti-gravity treadmill: refined air-pressure chamber, updated controls, Woodway slat-belt surface. TX/OK/NM dealer.",
    },
  },
  ...
  // GMTS RRB Shoulder to Overhead Lifting Box — product id "269"
  "269": {
    productId: "269",
    slug: "gmts-rrb-148r-shoulder-to-overhead-lifting-box",
    tagline:
      "Steel-reinforced lifting box with dowel rod for shoulder-to-overhead work hardening and functional capacity testing.",
    overview: [
      "The GMTS RRB Shoulder to Overhead Lifting Box is built for work hardening, work conditioning, and functional capacity evaluations. Its steel-reinforced construction and integrated dowel rod allow clinicians to safely load the box for progressive shoulder-to-overhead lifting protocols.",
      "Sized at 14\" x 8\" x 14\" with a 110 lb weight capacity, the box is compact enough for tight clinic footprints while still meeting the demands of industrial rehab. It is WORKSteps approved for use in standardized post-offer employment testing and return-to-work programs.",
    ],
    highlights: [
      "Steel reinforced box with dowel rod",
      "14\" x 8\" x 14\" dimensions",
      "110 lb weight capacity",
      "WORKSteps approved for FCE and post-offer testing",
      "Molded handles on both sides for two-handed lifts",
      "Durable powder-coat blue finish",
    ],
    gallery: [
      { src: "/assets/products/gmts-rrb-148r.jpg", alt: "GMTS RRB Shoulder to Overhead Lifting Box — three-quarter view" },
      { src: "/assets/products/gmts-rrb-148r-angle3.png", alt: "GMTS RRB Shoulder to Overhead Lifting Box — top-down three-quarter angle" },
    ],
    specGroups: [
      {
        title: "Dimensions",
        rows: [
          { label: "Size", value: "14\" x 8\" x 14\"" },
          { label: "Weight capacity", value: "110 lbs" },
          { label: "Construction", value: "Steel reinforced with dowel rod" },
          { label: "Handles", value: "Molded side handles" },
        ],
      },
      {
        title: "Clinical Use",
        rows: [
          { label: "Category", value: "Work Hardening / FCE" },
          { label: "Standard", value: "WORKSteps approved" },
          { label: "Applications", value: "Shoulder-to-overhead lifting, return-to-work testing" },
        ],
      },
    ],
    sourceUrl: "https://gmtherapytx.com",
    seo: {
      title: "GMTS RRB Shoulder to Overhead Lifting Box (148R) | GM Therapy",
      description:
        "GMTS RRB 148R steel-reinforced shoulder-to-overhead lifting box. 14\" x 8\" x 14\", 110 lb capacity, WORKSteps approved for work hardening and FCE.",
    },
  },

  // GMTS RRB Floor-to-Knuckle Lifting Box — product id "159"
  "159": {
    productId: "159",
    slug: "gmts-rrb-1414r-floor-to-knuckle-lifting-box",
    tagline:
      "Steel-reinforced cube lifting box with integrated weight post for floor-to-knuckle work hardening and functional capacity testing.",
    overview: [
      "The GMTS RRB Floor-to-Knuckle Lifting Box is designed for the heaviest work hardening protocols. Its 14\" cube form factor and integrated weight post allow clinicians to load the box progressively for floor-to-knuckle, floor-to-waist, and material handling tasks.",
      "Steel reinforced construction supports up to 200 lbs of load, making it suitable for industrial rehab, FCE, and post-offer employment testing. WORKSteps approved for standardized use across return-to-work programs.",
    ],
    highlights: [
      "Steel reinforced with integrated weight post",
      "14\" x 14\" x 14\" cube dimensions",
    ...
    gallery: [
      { src: "/assets/products/gmts-rrb-1414r.jpg", alt: "GMTS RRB Floor-to-Knuckle Lifting Box — three-quarter view" },
      { src: "/assets/products/gmts-rrb-1414r-angle2.png", alt: "GMTS RRB Floor-to-Knuckle Lifting Box — front view" },
      { src: "/assets/products/gmts-rrb-1414r-angle3.png", alt: "GMTS RRB Floor-to-Knuckle Lifting Box — elevated three-quarter angle" },
    ],
    specGroups: [
      {
        title: "Dimensions",
        rows: [
          { label: "Size", value: "14\" x 14\" x 14\"" },
          { label: "Weight capacity", value: "200 lbs" },
          { label: "Construction", value: "Steel reinforced with weight post" },
          { label: "Handles", value: "Molded side handles" },
        ],
      },
      {
        ...
        rows: [
          { label: "Category", value: "Work Hardening / FCE" },
          { label: "Standard", value: "WORKSteps approved" },
          { label: "Applications", value: "Floor-to-knuckle lifting, material handling, return-to-work testing" },
        ],
      },
    ],
    sourceUrl: "https://gmtherapytx.com",
    seo: {
      title: "GMTS RRB Floor-to-Knuckle Lifting Box (1414R) | GM Therapy",
      description:

...
export const productDetails: Record<string, ProductDetail> = {
  ...
  // Kinvent K-Push Wireless Push Dynamometer — product id "624"
  "624": {
    productId: "624",
    slug: "kinvent-k-push-dynamometer",
    tagline:
      "Wireless dynamometer for objective pushing strength testing — powered by the Kinvent app.",
    overview: [
      "The Kinvent K-Push is a connected, portable wireless dynamometer that turns any clinic, gym, or performance lab into an objective pushing-strength testing environment. It pairs with the Kinvent App on iOS or Android to deliver real-time force and asymmetry data for isometric pushing protocols.",
      "Used by physical therapists, sports medicine clinicians, and strength coaches, the K-Push quantifies what used to be subjective: peak force, average force, time-to-peak, and Limb Symmetry Index (LSI) across upper- and lower-extremity pushing assessments.",
      "K-Push integrates with the broader Kinvent ecosystem — K-Deltas, K-Pull, K-Power, K-Myo, K-Move — so you can build a complete assessment battery and trend patient progress over time inside one app.",
    ],
    highlights: [
      "Wireless dynamometer — objective pushing strength testing",
      "Quantify peak force, average force, and time-to-peak",
      "Bilateral comparison with Limb Symmetry Index (LSI)",
      "Upper- and lower-extremity isometric pushing protocols",
      "Real-time biofeedback via the Kinvent App (iOS / Android)",
      "Exportable PDF reports & longitudinal patient tracking",
      "Rechargeable, fully portable — set up anywhere in seconds",
      "Compatible with the full Kinvent ecosystem (K-Deltas, K-Pull, K-Power, K-Myo, K-Move)",
    ],
    gallery: [
      { src: "/assets/products/kinvent/k-push/K-Push-11.png", alt: "Kinvent K-Push wireless push dynamometer" },
      { src: "/assets/products/kinvent/k-push/K-Push-12.png", alt: "Kinvent K-Push — product view" },
      { src: "/assets/products/kinvent/k-push/K-Push-10.png", alt: "Kinvent K-Push — device detail" },
      { src: "/assets/products/kinvent/k-push/GG3A5685.jpg", alt: "Kinvent K-Push in clinical pushing assessment" },
      { src: "/assets/products/kinvent/k-push/GG3A5897.jpg", alt: "Kinvent K-Push pushing strength protocol" },
    ],
    specGroups: [
      {
        title: "Hardware",
        rows: [
          { label: "Type", value: "Wireless pushing dynamometer" },
          { label: "Connectivity", value: "Bluetooth — pairs with Kinvent App (iOS / Android)" },
          { label: "Power", value: "Rechargeable battery, fully portable" },
          { label: "Attachments", value: "Compatible with standard pushing pads and handles" },
        ],
      },
      {
        title: "Assessment Protocols",
        rows: [
          { label: "Strength", value: "Isometric pushing — peak force, average force, time-to-peak" },
          { label: "Asymmetry", value: "Bilateral comparison with Limb Symmetry Index (LSI)" },
          { label: "Regions", value: "Upper- and lower-extremity pushing protocols" },
          { label: "Tracking", value: "Trended progress across sessions" },
        ],
      },
      {
        ...
        rows: [
          { label: "App", value: "Kinvent App — real-time biofeedback & reports" },
          { label: "Reporting", value: "Exportable PDF reports, trended patient data" },
          { label: "Ecosystem", value: "Integrates with K-Deltas, K-Pull, K-Power, K-Myo, K-Move" },
        ],
      },
      {
        title: "Dealer Support",
    ...
    specSheetUrl: "/assets/products/kinvent/downloads/product-sheet-k-push-en.pdf",
    specSheetTitle: "Product Sheet (English)",
    sourceUrl: "https://kinvent.com/",
    seo: {
      title: "Kinvent K-Push Wireless Push Dynamometer | GM Therapy",
      description:
        "Wireless dynamometer for objective isometric pushing strength testing and Limb Symmetry Index. Powered by the Kinvent App.",
    },
  },
  ...
  "702": {
    ...
    gallery: [
      ...
      { src: "/assets/products/boost/b2_20230617-722A1833_1.jpg", alt: "Athlete training inside a BOOST microgravity treadmill" },
      { src: "/assets/products/boost/b2_UI_Weight.webp", alt: "BOOST touchscreen — bodyweight reduction control" },
      { src: "/assets/products/boost/b2_UI_Incline.webp", alt: "BOOST touchscreen — incline control" },
      { src: "/assets/products/boost/b2_UI_Programs.webp", alt: "BOOST touchscreen — pre-programmed workouts" },
      { src: "/assets/products/boost/b2_UI_Tracking.webp", alt: "BOOST touchscreen — performance tracking metrics" },
    ],
    specGroups: [
      {
        title: "Performance",

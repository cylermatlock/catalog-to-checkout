...
export const products: Product[] = [
  ...
  { id: "139", name: "Matrix Versa Hip Abductor / Adductor", category: "Strength Equipment", subcategory: "MATRTIX VERSA DUAL", sku: "VS-S74", description: ["Dual-function inner and outer thigh", "Easy switch between abduction and adduction", "Adjustable range of motion", "Comfortable leg pads", "Stable seated platform"] },

...
export const products: Product[] = [
  ...
  { id: "125", name: "Matrix Lifestyle Recumbent Cycle", category: "Cardio", subcategory: "Recumbent Cycles", sku: "R-LS-LED", description: ["LED Console with intuitive controls", "Ergo Form seat for all-day comfort", "Step-through design for easy access", "Self-balancing pedals", "Compact frame fits any space", "Reliable, low-impact cardio"] },
  { id: "126", name: "Matrix Lifestyle Upright Cycle", category: "Cardio", subcategory: "Upright Cycles", sku: "U-LS-LED", description: ["LED Console with intuitive controls", "Ergo Form seat for comfort", "Dual-position handlebars", "Adjustable seat height with step-through design", "Self-balancing pedals and forged 3-piece crank", "Self-powered options simplify placement"] },
];

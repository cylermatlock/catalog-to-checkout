...
export const products: Product[] = [
  ...
  { id: "127", name: "Matrix Versa Converging Chest Press", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S13", description: ["Converging press path for natural movement", "Adjustable seat for proper alignment", "Easy-entry design", "Durable commercial-grade construction", "Streamlined aesthetics for any facility"] },
  { id: "128", name: "Matrix Versa Pec Fly / Rear Delt", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S22", description: ["Dual-function pec fly and rear delt", "Adjustable start positions", "Comfortable arm pads", "Smooth, controlled motion", "Space-efficient footprint"] },
  { id: "129", name: "Matrix Versa Converging Shoulder Press", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S23", description: ["Converging press path for natural shoulder movement", "Multi-grip handles", "Adjustable seat", "Easy-access design", "Commercial-grade durability"] },
  { id: "130", name: "Matrix Versa Diverging Lat Pulldown", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S33", description: ["Diverging path mimics natural movement", "Adjustable thigh pad", "Multi-grip handles", "Smooth pulley system", "Comfortable seat positioning"] },
  { id: "131", name: "Matrix Versa Diverging Seated Row", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S34", description: ["Diverging row path for natural pull", "Adjustable chest pad", "Multi-grip handles", "Solid stabilization", "Commercial-grade build"] },
  { id: "132", name: "Matrix Versa Bicep Curl", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S40", description: ["Isolated bicep curl motion", "Adjustable seat for proper arm alignment", "Comfortable arm pad", "Smooth resistance curve", "Easy-entry design"] },
  { id: "133", name: "Matrix Versa Triceps Press", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S42", description: ["Isolated tricep press motion", "Adjustable seat", "Comfortable arm pads", "Smooth, controlled motion", "Compact footprint"] },
  { id: "134", name: "Matrix Versa Back Extension", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S52", description: ["Targeted lower back strengthening", "Adjustable range of motion", "Padded back roller", "Stable foot platform", "Commercial-grade construction"] },
  { id: "135", name: "Matrix Versa Abdominal", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S53", description: ["Targeted abdominal training", "Adjustable resistance and range", "Comfortable chest pad", "Smooth motion path", "Easy-entry design"] },
  { id: "136", name: "Matrix Versa Leg Press / Calf Press", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S70", description: ["Dual-function leg and calf press", "Adjustable back pad", "Large foot platform", "Heavy-duty frame", "Smooth weight stack motion"] },
  { id: "137", name: "Matrix Versa Leg Extension", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S71", description: ["Isolated quadriceps training", "Adjustable back pad and range of motion", "Comfortable shin roller", "Smooth motion arc", "Commercial-grade durability"] },
  { id: "138", name: "Matrix Versa Seated Leg Curl", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S72", description: ["Isolated hamstring training", "Adjustable thigh hold-down", "Comfortable shin roller", "Smooth motion path", "Easy-entry seated design"] },
  { id: "139", name: "Matrix Versa Hip Abductor / Adductor", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S74", description: ["Dual-function inner and outer thigh", "Easy switch between abduction and adduction", "Adjustable range of motion", "Comfortable leg pads", "Stable seated platform"] },
  { id: "140", name: "Matrix Versa Glute", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S78", description: ["Targeted glute strengthening", "Comfortable chest and forearm pads", "Adjustable range of motion", "Smooth resistance curve", "Stable platform"] },
  { id: "141", name: "Matrix Versa Multi Press", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S131", description: ["Multi-function chest and shoulder press", "Adjustable seat for press variations", "Multi-grip handles", "Space-saving dual-function design", "Commercial-grade build"] },
  { id: "142", name: "Matrix Versa Lat Pulldown / Seated Row", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S331", description: ["Dual-function pulldown and row", "Adjustable thigh and chest pads", "Multi-grip handles", "Smooth pulley system", "Space-efficient design"] },
  { id: "143", name: "Matrix Versa Bicep / Tricep", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S401", description: ["Dual-function arm trainer", "Easy switch between bicep and tricep", "Adjustable seat", "Comfortable arm pad", "Compact footprint"] },
  { id: "144", name: "Matrix Versa Ab / Low Back", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S531", description: ["Dual-function abdominal and lower back", "Adjustable range of motion", "Comfortable padding", "Smooth motion path", "Space-saving design"] },
  { id: "145", name: "Matrix Versa Chin / Dip Assist", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S601", description: ["Assisted chin-up and dip station", "Adjustable assistance via weight stack", "Comfortable knee platform", "Multi-grip handles", "Stable, heavy-duty frame"] },
  { id: "146", name: "Matrix Versa Leg Extension / Leg Curl", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "VS-S711", description: ["Dual-function leg extension and curl", "Adjustable back pad and range of motion", "Comfortable shin roller", "Smooth motion path", "Space-efficient design"] },
  { id: "147", name: "Matrix Versa MD Adjustable Pulley", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "MD-AP", description: ["Multi-position adjustable pulley", "Versatile cable training options", "Smooth pulley system", "Compact footprint", "Commercial-grade construction"] },
  { id: "148", name: "Matrix Versa MD Leg Press", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "MD-S70", description: ["Compact leg press design", "Adjustable back pad", "Large foot platform", "Heavy-duty frame", "Smooth weight stack motion"] },
  { id: "149", name: "Matrix Versa MD Leg Extension / Leg Curl", category: "Strength Equipment", subcategory: "Versa Single-Station", sku: "MD-S711", description: ["Compact dual-function leg trainer", "Adjustable back pad and range", "Comfortable shin roller", "Smooth motion path", "Space-efficient design"] },
];

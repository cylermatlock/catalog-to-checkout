...
export const products: Product[] = [
  ...
  { id: "9", name: "Armedica Power Parallel Bars", category: "Rehab Furniture", subcategory: "Parallel Bars", sku: "AM 700", description: ["Digital user friendly display", "Memory buttons for storage", "Microprocessor control unit", "Heavy duty construction", "Height monitoring functions", "Slip-resistant platform", "400 lb weight capacity"] },
  ...
  { id: "13", name: "Ideal Dumbbell Storage VWR30", category: "Rehab Furniture", subcategory: "Storage", sku: "IM VWR30", description: ["Wall stand for smaller dumbbells", "Grey powdercoat finish", "Welded steel construction", "60 lb total capacity 10 hooks"] },
  ...
  { id: "16", name: "Chattanooga DTS Decompression System", category: "Rehab Furniture", subcategory: "Traction Tables", sku: "CG 8250-6000002", description: ["Fully programmable pull patterns", "Isolation of pretension, progression, traction & regressions", "Variable speed control", "5 unique patterns", "Up to 80 user defined settings"] },
  { id: "17", name: "Mettler Neural Flex Decompression System", category: "Rehab Furniture", subcategory: "Traction Tables", sku: "ME 4100", description: ["Deep lumbar flexion", "Bolster-less leg elevation", "Axilla posts with upper belt", "Directional preference positioning", "Full pivoting at L5", "Inversion with whole body vibration"] },
  { id: "18", name: "GMTS Traction Package", category: "Rehab Furniture", subcategory: "Traction Tables", sku: "GMTS TRAC-NEW", description: ["4 section MedSurface table", "Triton traction head", "New accessories & belts"] },
  ...
  { id: "32", name: "InTENSity CX4 Electrotherapy and Ultrasound", category: "Modalities", subcategory: "E-Stim/Ultrasound", sku: "RM DQ8200", description: ["5 cm² sound head", "Treats up to 4 patients at once", "Multiple waveforms", "Large color LCD touchscreen", "3 year warranty"] },
  ...
  { id: "34", name: "InTENSity CX2 Electrotherapy and Ultrasound", category: "Modalities", subcategory: "E-Stim/Ultrasound", sku: "RICH DQ8222", description: ["5 cm² sound head", "Multiple waveforms", "Large color LCD touchscreen", "3 year warranty", "Optional cart available"] },
  ...
  { id: "71", name: "Shuttle Systems 2000-1 Clinical", category: "Strength Equipment", subcategory: "Shuttle Systems", sku: "CD 2100A", description: ["Supine Leg Press", "8 elasticords up to 160 lbs", "Early stage rehabilitation tool", "Resistance starts at 3 lbs"] },
  ...
  { id: "107", name: "Digi Flex Hand Exercisers", category: "Clinical Supplies", subcategory: "Hand Exercisers", sku: "FAB 10-0740", description: ["Individual finger exercise", "Color-coded resistance levels", "Develops isolated finger strength"] },
